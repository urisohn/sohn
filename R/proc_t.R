...
#' \itemize{
#'   \item \code{group1}: Name of the first group (or "x" for standard syntax, NA for one-sample test)
#'   \item \code{group2}: Name of the second group (or "y" for standard syntax, NA for one-sample test)
#'   \item \code{mean1}: Mean of the first group
#'   \item \code{mean2}: Mean of the second group (NA for one-sample test)
...
#'   \item \code{N1}: Sample size of first group
#'   \item \code{N2}: Sample size of second group (NA for one-sample test)
#'   \item \code{NA1}: Number of missing observations in first group
#'   \item \code{NA2}: Number of missing observations in second group (NA for one-sample test)
...
proc_t <- function(...) {
  ...
  class(result) <- c("proc_t", class(result))
